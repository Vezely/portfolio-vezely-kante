		...
		<div style={{ width: '100%', textAlign: 'center', backgroundColor: 'black' }}>
			<h2
				style={{
					...
					margin: '60px 0 0 0',
					color: 'transparent',
					backgroundImage: 'linear-gradient(90deg, #b0f3f1, #ffcfdf)',
					fontSize: '2.5rem',
					fontWeight: 'bold',
				}}>
				A propos de moi
				...
				<div className={styles.text}>
					...
					<div className={styles.description}>
						...
						<p className={styles.paragraph}>
							...
							une application de gestion de tâches pour un ami entrepreneur et un site web pour une organisation à but non lucratif. Ces
							projets m&apos;ont aidé à développer mes compétences et à les appliquer dans des contextes réels.
						</p>
						<p className={styles.paragraph}>
