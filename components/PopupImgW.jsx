...
const PopupImgW = ({ voir, img, Img, title, Width, Height, liens, descriptions, Technolo, lien_site }) => {
	...
	const [lien_sites, setLien_sites] = useState(lien_site);
	const [lien_existe, setLien_existe] = useState(lien_sites);
	const [tethnologie, setTethnologie] = useState(Technolo);

	// obtenir tous les projets de typpe web
	const projetWeb = projets.filter((image) => image.type === 'web');
					...
					<div className={styles.techImg}>
						...
						<div className={styles.technologies}>
							...
							<ul className={styles.ul}>
								{projetWeb[tethnologie].technologies.map((tech, index) => (
